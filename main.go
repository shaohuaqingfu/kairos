...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-bind-address", ":8080", "指标端点绑定的地址。")
	flag.StringVar(&probeAddr, "health-probe-bind-address", ":8081", "探针端点绑定的地址。")
	flag.BoolVar(&enableLeaderElection, "leader-elect", false,
		"为控制器管理器启用领导者选举。 "+
			"启用此功能将确保只有一个活动的控制器管理器。")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "80807133.kairos.io",
	})
	if err != nil {
