...
helm.sh/chart: {{ include "kairos-operator.chart" . }}
{{ include "kairos-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "kairos-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
